  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <a href="https://youtube.com/@yaha_bhi_athens" target="_blank" title="YouTube">
          <div i-simple-icons-youtube />
        </a>
        <a href="https://instagram.com/axat.moments" target="_blank" title="Instagram" class="lt-md:hidden">
          <div i-simple-icons-instagram />
        </a>
        <a href="https://github.com/RA1-Asur" target="_blank" title="GitHub" class="lt-md:hidden">
